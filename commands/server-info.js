    ...
    async execute(interaction) {
        ...
        const serverEmbed = new MessageEmbed()
            ...
            .addFields( 
                ...
                //{ name: "[+2] Given out: ", value:`\`${guild.wave_battle_history.plus_twos_given.toString()}\`` ,inline:true },
                //{ name: "[-2] Given out: ", value:`\`${guild.wave_battle_history.minus_twos_given.toString()}\`` ,inline:true },

                { name: `${header} **Server Beverage History** ${header}`, value: ` `},
                ...
                { name: `:bubble_tea:Bubble Tea`, value: `\`${(guild.server_drink_stats.bubble_tea).toString()}\``, inline: true},
                ...
                { name: `:sake:Sake`, value: `\`0\``, inline: true},
            )
